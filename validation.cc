...
int main() {
    TFile f("/cluster/tufts/beaucheminlab/svenet01/WplusJetsAnalysis/pythia-outputs/2025/testing_021226.root"); // read input file
    ...
    TH1* h1 = nullptr; 
    TH1* h2 = nullptr;
    h1 = new TH1D("h1", "Delta pT between Taus and Decay Products", 20, -1, 1);
    h2 = new TH1D("h2", "Delta pT between Z and Taus", 20, -1, 1);
    ...
    TH1* h4 = nullptr; // py
    TH1* h5 = nullptr; // pz
    h3 = new TH1D("h3", "Delta px between Taus and Decay Products", 20, -1, 1);
    h3->SetDirectory(nullptr);

    h4 = new TH1D("h4", "Delta py between Taus and Decay Products", 20, -1, 1);
    h4->SetDirectory(nullptr);

    h5 = new TH1D("h5", "Delta pz between Taus and Decay Products", 20, -1, 1);
    ...
    TH1* h7 = nullptr; // py
    TH1* h8 = nullptr; // pz
    h6 = new TH1D("h6", "Delta px between Z and Taus", 20, -1, 1);
    h6->SetDirectory(nullptr);

    h7 = new TH1D("h7", "Delta py between Z and Taus", 20, -1, 1);
    h7->SetDirectory(nullptr);

    h8 = new TH1D("h8", "Delta pz between Z and Taus", 20, -1, 1);
    ...
    fout3.cd();
    h3->GetXaxis()->SetTitle("Delta px between Z and Taus [GeV]");
